...
describe KSUID do
  it "MIN" do
    ...
    min.payload.should eq Bytes.new(KSUID::PAYLOAD_SIZE, 0_u8)
  ...
  it "MAX" do
    ...
    max.payload.should eq Bytes.new(KSUID::PAYLOAD_SIZE, 255_u8)
  ...
  describe ".from" do
    context "String" do
      it "constructs new KSUID from valid string" do
        ...
        ksuid.payload.hexstring.should eq "d7b6fe8cd7cff211704d8e7b9421210b"
